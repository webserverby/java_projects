...
![CC0](https://github.com/webserverby/java_projects/blob/master/TravelAgency/src/screenshots/turist_1.png)


## Добавление туриста
## Обязательные поля для ввода "Фамилия, Имя, Отчество туриста"
## Вносим данные нажимаем кнопку  "Создать"
![CC0](https://github.com/webserverby/java_projects/blob/master/TravelAgency/src/screenshots/turist_2.png)
